    ...
    for racine, dossiers, fichiers in os.walk(chemin): 
        ...
        for fichier in fichiers: # Itère à travers la liste des fichiers obtenus à partir de la boucle précédente.
            if fichier.endswith(".vcf"): 
                ...
                # .join concatène le chemin relatif au projet de la raçine (juste le nom du premier dossier) et le chemin du fichier (qui contient aussi le nom du fichier)
...
#                                       '/home/emmamlinux/documents/Aide/Data/Data/P15/P15-2.trimed1000.sv_sniffles.vcf']} s